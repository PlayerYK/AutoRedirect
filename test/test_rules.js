    ...
    // ===== 本地文件重定向测试 =====
    {
        ...
        tests: [
            ...
            },
            {
                ...
                input: "file:///Users/ExtTeam/dev/ChromeStore/autoRedirect/autoredirect_test.html",
                expected: "https://www.example.com/autoRedirect/",
                rule: "=file:///Users/ExtTeam/dev/ChromeStore/autoRedirect/autoredirect_test.html####https://www.example.com/autoRedirect/"
            },
            {
                name: "路径通配符匹配 - 提取文件名",
            ...
            },
            {
                ...
                rule: "=file:///Users/ExtTeam/dev/ChromeStore/autoRedirect/*.html####https://www.example.com/{1}/"
            },
            {
                name: "多通配符匹配 - 子目录支持",
